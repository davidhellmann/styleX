...
export declare const invalidDefineVarsFunctionValue: () => string;
export declare type invalidDefineVarsFunctionValue =
  typeof invalidDefineVarsFunctionValue;
export declare const cyclicDefineVarsReference: (cycle: string) => string;
export declare type cyclicDefineVarsReference =
  typeof cyclicDefineVarsReference;
export declare const unknownDefineVarsReference: (
  key: string,
  dependency: string,
) => string;
export declare type unknownDefineVarsReference =
  typeof unknownDefineVarsReference;
...
export declare const LINT_UNCLOSED_STRING: 'Rule contains an unclosed string';
export declare type LINT_UNCLOSED_STRING = typeof LINT_UNCLOSED_STRING;
