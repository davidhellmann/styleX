...
declare class StateManager {
  ...
  readonly stylexDefineVarsNestedImport: Set<string>;
  readonly stylexDefineConstsNestedImport: Set<string>;
  readonly stylexCreateThemeNestedImport: Set<string>;
  readonly stylexConditionalImport: Set<string>;
  readonly atomImports: Map<string, string>;
